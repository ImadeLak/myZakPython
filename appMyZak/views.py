...
from appMyZak.serializers import UserSerializer, GroupSerializer, DepartementSerializer, BanqueSerializer, CompteBancaireSerializer, SituationSerializer, HistoriqueSerializer
...
class UserViewSet(viewsets.ModelViewSet):
    ...
    """
    queryset = UserCustom.objects.all().order_by('-date_joined')
